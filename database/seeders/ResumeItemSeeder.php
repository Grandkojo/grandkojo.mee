...
class ResumeItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ResumeItem::create([
            ...
            'description' => 'Build software systems with Java.
                            Work on building new features and improving existing products.
                            Work with other developers, engineers, DevOps, and product owners to meet goals.
                            Address and resolve technical challenges and complexity.',
            'order' => 1,
        ]);
        ResumeItem::create([
            'type' => 'experience',
